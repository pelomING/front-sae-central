...
@Component({
  selector: 'app-cobros_adicionales',
  templateUrl: './cobros_adicionales.component.html',
  styleUrls: ['./cobros_adicionales.component.scss'],
  providers: [MessageService]
})

export class Cobros_adicionalesComponent implements OnInit {
